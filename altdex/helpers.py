...
def collect():
    ...
    for coin in coins:
        ...
        if coin.symbol == 'BCO':
        ...
        elif coin.symbol == 'NIX':
            url2 = 'https://api.coinmarketcap.com/v2/ticker/2991/'
            r2 = requests.get(url2)
        ...
        elif coin.symbol == 'LOKI':
            url2 = 'https://api.coinmarketcap.com/v2/ticker/2748/'
            r2 = requests.get(url2)
        ...
        elif coin.symbol == 'LGO':
            url2 = 'https://api.coinmarketcap.com/v2/ticker/2600/'
            r2 = requests.get(url2)
            ...
            coin.volume = 0
            # float('{0:.0f}'.format(data['data']['quotes']['USD']['volume_24h']))
            coin.market_cap = float('{0:.0f}'.format(data['data']['quotes']['USD']['market_cap']))
            coin.percent_weight = 0
